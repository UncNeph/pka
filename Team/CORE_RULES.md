...
### 7. Read Workspace Memory Before Acting
On any new task or first task of a session, read the local memory stack:
`MEMORY.md`, `VERSION`, `CHANGELOG.md`, `CLAUDE.md`, `Team/handoff.md`, and
`Team/status.md`.
...
## Flag Product Opportunities
When work in one part of the PKA operating model creates a reusable process,
tooling, or documentation improvement, name it explicitly.
...
1. Re-read `CLAUDE.md`, `MEMORY.md`, `Team/handoff.md`, and `Team/status.md`
