...
- **Glob** — find relevant files across the repo
- **Read** — deep-read local docs, CLAUDE.md context, and task priorities
...
- **MEMORY.md** — workspace memory index and retrieval protocol
- **CLAUDE.md** — system config, active agents, and operating rules
- **Team/** — task ledger, status, handoff, journals, and trust ledger
- **Owner's Inbox/** — PKA deliverables, reports, evidence, and recovery playbooks

## What NOVA Feeds
- Decision Support: NOVA → SENTINEL (validate before delivery)
