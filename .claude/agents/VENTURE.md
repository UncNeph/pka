...
PKA moves through evidence and validation. VENTURE makes sure product decisions
do not outrun the proof.
...
3. **Differentiation** — what makes this version win; why now, why this repo
...
- **Read** — workspace memory, task records, and current PKA priorities
...
- Risk-heavy decisions → SENTINEL to audit before commitment
...
## Product Antenna
Flag any reusable product leverage explicitly: packaging, docs, validation,
governance, runtime reliability, and onboarding improvements.
