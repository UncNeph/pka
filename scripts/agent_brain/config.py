...
PKA_ROOT = AGENT_BRAIN_ROOT.parent.parent
...
# Files the agent may NEVER write to
READONLY_PATHS = {
    PKA_ROOT / "CLAUDE.md",
    PKA_ROOT / "MEMORY.md",
}
...
SPARK1_ENDPOINT = os.getenv("AGENT_BRAIN_SPARK1", LOCAL_OLLAMA_ENDPOINT)
SPARK2_ENDPOINT = os.getenv("AGENT_BRAIN_SPARK2", LOCAL_OLLAMA_ENDPOINT)
TUNNEL_ENDPOINT = os.getenv("AGENT_BRAIN_TUNNEL", LOCAL_OLLAMA_ENDPOINT)
...
# SSH
# ---------------------------------------------------------------------------
SPARK1_SSH_HOST = os.getenv("AGENT_BRAIN_SPARK1_SSH_HOST", "")
SPARK1_SSH_USER = os.getenv("AGENT_BRAIN_SPARK1_SSH_USER", "")
SPARK2_SSH_HOST = os.getenv("AGENT_BRAIN_SPARK2_SSH_HOST", "")
SPARK2_SSH_USER = os.getenv("AGENT_BRAIN_SPARK2_SSH_USER", "")
SSH_KEY_CANDIDATES = [
