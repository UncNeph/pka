...
- You are running on Windows; remote hosts are available only when configured by environment variables.
...
RULES:
- Never write to CLAUDE.md or MEMORY.md
- Do not send workspace context or memory files to external APIs
